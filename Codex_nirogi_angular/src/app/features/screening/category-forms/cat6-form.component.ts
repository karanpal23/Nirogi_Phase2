...
@Component({
  selector: 'app-cat6-form',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './cat6-form.component.html',
  styleUrl: './cat6-form.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class Cat6FormComponent {
  readonly definition = CATEGORY_FORM_DEFINITIONS.CAT6;

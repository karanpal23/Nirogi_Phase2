...
@Component({
  selector: 'app-cat2-form',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './cat2-form.component.html',
  styleUrl: './cat2-form.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class Cat2FormComponent {
  readonly definition = CATEGORY_FORM_DEFINITIONS.CAT2;

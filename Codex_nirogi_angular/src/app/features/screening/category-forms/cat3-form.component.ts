...
@Component({
  selector: 'app-cat3-form',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './cat3-form.component.html',
  styleUrl: './cat3-form.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class Cat3FormComponent {
  readonly definition = CATEGORY_FORM_DEFINITIONS.CAT3;

...
@Component({
  selector: 'app-cat1-form',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './cat1-form.component.html',
  styleUrl: './cat1-form.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class Cat1FormComponent {
  readonly definition = CATEGORY_FORM_DEFINITIONS.CAT1;
